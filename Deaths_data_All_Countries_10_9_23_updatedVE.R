...
col_names = c("Country","Observed deaths","Observed deaths, rate per 100,000 population","Deaths averted, average",
              ...
              "% under 60 vaccinated at end date","population")
...
# Assign vaccine effectiveness by age and dose
# 
...
Deaths_averted_data[i,14] <- population
...
#write.csv(Model_data, file="Model_data_fullcountries_92623.csv")
...
# pdf(file="Country_Data_Table_91823.pdf", width=40)
# grid.table(Deaths_averted_data)
# dev.off()

#write.csv(Deaths_averted_data, "Output/Supplementary_Table_One_10_9_23.csv")
  
pdf(file="Output/Supplementary_Figure_2_10923.pdf", width=20)
